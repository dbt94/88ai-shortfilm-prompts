...
> 🎬 **用模板之前,先过四道门** · [AI 漫剧实战·第一部：能不能做 →](https://aiolaola.com/course/ai-comic-drama?utm_source=github&utm_campaign=shortfilm)
> 免费 35 节：备案分档、六家工具协议逐条对照、真实成本(废片率/每成品分钟)、分镜级规格。前 12 节免登录。
...
> **一个 Claude Code Skill:把任何创意变成可直接投喂 Sora / 可灵 / Veo /
> Seedance 的电影感提示词。** 21 个题材模板、5 段式结构、evals 质量把关。
> 方法论首发拆解自 Mx-Shell《丧尸清道夫》(Zombie Scavenger)——
> **好莱坞导演 PJ Ace 评为"近年来最佳短片之一"** 的作品。
...
│   ├── product-commercial.md        ← 实战范例：分秒 beat 产品带货硬广
│   ├── food-asmr.md                 ← 实战范例：食物 ASMR·原生同步音效
